...
public class SolrUtils {
    ...
    private static final String solrUrlHymns = "http://localhost:8983/solr/ppdiscover";
    private static final String solrUrlSermons = "http://localhost:8983/solr/ppdiscover-sermons";
